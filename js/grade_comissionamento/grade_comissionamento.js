$(document).ready(function () {
    ...
    $('#tbl_grade_comissionamento').delegate('a', 'click', function () {
        $(this).closest('tr').remove();
    });

    $('#tbl_grade_comissionamento').delegate('tr', 'click', function () {
    ...
    $("#select_colaborador").change(function () {

        var colaborador = $("#select_colaborador option:selected").val();
        var mensagem = "";

        if (colaborador === "0000") {
            mensagem = "Selecione um tipo para colaborador!";
    ...
    $("#btn_modal_salvar").click(function () {
        ...
        $('#tbl_grade_comissionamento tbody').find('tr').each(function (i) {
