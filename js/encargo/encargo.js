$(document).ready(function () {
    ...
    $("#btn_painel_editar").click(function () {
        ...
        var ukey_encargo = $("input[type=checkbox][name = 'check[]']:checked").attr("id");
        var url = $(this).attr("itemid");
...
function  preencherObjetoEncargo(data) {
    $("#ukey").val(data.ukey);
    $("#nome").val(data.nome);
