<form id="<?php echo $id_form ?>" onsubmit="return false">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-6">
                <label for="grade">Empresa</label>
                <select disabled="" class="form-control" id="select_grade">
                    <?php foreach ($lista_grade_empresa as $objGrade) : ?>
                        <option id="<?php echo $objGrade['ukey'] ?>" name="<?php echo $objGrade['ukey'] ?>" value="<?php echo $objGrade['ukey'] ?>"><?php echo $objGrade['nome_fantasia'] ?></option>
                    <?php endforeach ?>
                </select>
            </div>
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <select disabled="" class="form-control" id="select_colaborador">
    ...
    <div class="form-group">
        <table class="table table-bordered" id="tbl_grade_comissionamento_empresa">
            <thead>
                <tr class="info" >
